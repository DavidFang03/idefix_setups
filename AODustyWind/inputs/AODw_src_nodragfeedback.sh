...
srun --nodes=2 --ntasks-per-node=4 \
     ...
     /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyWind/setup/idefix -restart -dec 4 2 -i /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyWind/inputs/AODw_src_nodragfeedback.ini
