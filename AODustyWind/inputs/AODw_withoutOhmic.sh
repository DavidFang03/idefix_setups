...
#SBATCH --job-name=AODw_withoutOhmic
...
srun --nodes=1 --ntasks-per-node=4 \
     ...
     /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyWind/setup/idefix -restart -dec 4 1 -i /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyWind/inputs/AODw_withoutOhmic.ini
