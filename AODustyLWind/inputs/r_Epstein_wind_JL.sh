...
#SBATCH --job-name=r_Epstein_wind_JL
...
srun --nodes=1 --ntasks-per-node=1 \
     ...
     /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyLWind/reload_l/idefix -dec 1 1 -i /home/dp316/dp316/dc-fang1/IdefixRuns/AODustyLWind/inputs/r_Epstein_wind_JL.ini
